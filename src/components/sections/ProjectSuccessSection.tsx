...
import { projectSuccessCopy } from '../../data/copy/projectSuccess';
import { useAppLanguage } from '../../hooks/useAppLanguage';

interface ProjectSuccessSectionProps {
  onCtaClick?: () => void;
}

export const ProjectSuccessSection: React.FC<ProjectSuccessSectionProps> = ({
  onCtaClick,
}) => {
  const { lang } = useAppLanguage();
  const content = projectSuccessCopy[lang];
