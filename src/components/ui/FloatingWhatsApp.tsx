...
export const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({
  ...
  const defaultMessage = lang === 'id'
    ? 'Halo Tim SSD, saya ingin konsultasi mengenai pengadaan armada EV untuk bisnis saya.'
    : 'Hello SSD Team, I would like to consult regarding EV fleet procurement for my business.';
